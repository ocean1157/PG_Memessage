...
- “对话原文”会跟随官方归档的线程清单抓取关联邮件正文，并按时间线显示成类似聊天的左右气泡，清晰区分发件人、收件人、抄送、主题和附件，并自动去掉上一封邮件的引用内容。
...
5. 切到“对话原文”查看邮件往返；对话页只显示每封邮件新增内容，会过滤上一封邮件引用。旧数据如果只有线程索引没有正文，重新抓取对应月份即可补全。
